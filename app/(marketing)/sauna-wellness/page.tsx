...
const features = [
  ...
  },
  {
    ...
    body: "Mittwochs von 11:00 bis 21:30 Uhr ausschließlich für unsere weiblichen Mitglieder. Eine bewusste Pause vom gemischten Saunabetrieb.",
  },
  {
    ...
    <>
            ...
            {features.map((f, i) => (
              <RevealOnScroll key={f.title} delay={i * 0.04}>
                <BentoCard variant="dark" className="h-full">
                  ...
                  <h3 className="text-h4 mt-4 font-display font-medium leading-snug tracking-tight">
                    {f.title}
                  </h3>
      ...
      <section className="py-16 lg:py-24">
        <div className="container-grid grid gap-10 lg:grid-cols-[1fr_1.4fr]">
          <div>
            ...
            <h2 className="text-h3 font-display font-medium leading-snug tracking-tight">
              Wann der Wellness-Bereich offen ist.
            </h2>
            <p className="mt-4 text-fg-muted">
              Mittwochs ist Damensauna — von 11:00 bis 21:30 Uhr
      ...
      <section className="py-16">
        <div className="container-grid">
          ...
          <h2 className="text-h3 mb-8 max-w-[20ch] font-display font-medium leading-snug tracking-tight">
            ...
            <div className="relative overflow-hidden rounded-frame border border-border bg-bg-elevated p-10 md:p-14">
              <div className="relative z-10 flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between">
                <div className="max-w-xl">
                  ...
                  <p className="text-h3 font-display font-medium leading-snug tracking-tight">

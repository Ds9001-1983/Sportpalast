...
export const metadata: Metadata = {
  ...
  description:
    "Ganzheitliche Gesundheit im Sportpalast Lindlar — Muskelaufbau, Rückentraining, Prävention, Rehasport, Firmenfitness.",
};

const healthGroup = NAVIGATION.find((g) => g.label === "Gesundheit");

export default function GesundheitOverviewPage() {
  return (
    <>
      <PageHero
        eyebrow="Gesundheitsziele"
        title="Gesundheit ist dein kostbarstes Gut."
        intro="Wir denken Fitness ganzheitlich — von Prävention über Rehasport bis Stressabbau. Jedes Programm individuell, jedes Ziel ernstgenommen."
      />
